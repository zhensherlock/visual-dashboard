<template>
  <el-tabs type="border-card" class="chart-option-tab" v-model="tabActiveName">

    <el-tab-pane class="chart-option-tab-item" label="数据管理" name="dataManage" v-if="currentObjectData.type != 'canvas'">

      <HotTable ref="chartDataHot" :root="root" :settings="hotSettings"></HotTable>

    </el-tab-pane>

    <el-tab-pane class="chart-option-tab-item" label="样式管理" name="styleManage" v-if="currentObjectData.type != 'canvas'">
      <div id="chart-title">
        <el-checkbox v-model="currentObjectData.chartOptions.chartTitle.visible" @change="resetChartOptions">显示标题
        </el-checkbox>
        <el-input v-model="currentObjectData.chartOptions.chartTitle.text" placeholder="请输入标题"
                  @change="resetChartOptions"></el-input>
    ...
    <el-tab-pane class="chart-option-tab-item" label="画布管理" name="canvasManage" v-if="currentObjectData.type == 'canvas'">
